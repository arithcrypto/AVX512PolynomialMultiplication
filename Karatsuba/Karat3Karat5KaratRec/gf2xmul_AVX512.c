 ...
 * @param[in] B Pointer to the polynomial B(x)
 */
int karat_mult3_5_AVX512(uint64_t *Out, const uint64_t *A, const uint64_t *B) {
	...
	karat_five_way_mult_m512i(D3, aa01, bb01);
	karat_five_way_mult_m512i(D4, aa02, bb02);
	karat_five_way_mult_m512i(D5, aa12, bb12);
