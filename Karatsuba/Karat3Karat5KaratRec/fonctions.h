...
#define SIZE_N (T_5W*15)

#define SIZE_N_64 ((T_5W*15)>>6)

#define TREC_3W (T_5W*5)
...
int karat_mult3_5(uint64_t * C, const uint64_t * A, const uint64_t * B);

int karat_mult3_5_AVX512(uint64_t * C, const uint64_t * A, const uint64_t * B);
