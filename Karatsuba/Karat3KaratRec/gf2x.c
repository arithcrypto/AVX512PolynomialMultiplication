...
inline static void karat_three_way_mult(__m256i *Out, const __m256i *A, const __m256i *B) {
	...
	karat_mult_64(D3, aa01, bb01);
	karat_mult_64(D4, aa02, bb02);
	karat_mult_64(D5, aa12, bb12);
#endif

#if T_3W == 32768
	karat_mult_128(D0, a0, b0);
	karat_mult_128(D1, a1, b1);
	karat_mult_128(D2, a2, b2);

	karat_mult_128(D3, aa01, bb01);
	karat_mult_128(D4, aa02, bb02);
	karat_mult_128(D5, aa12, bb12);
#endif
...
//
*************************************************************************************/
int karat_mult3(uint64_t *Out, const uint64_t *A, const uint64_t *B) {
	__m256i *A256 = (__m256i *)A, *B256 = (__m256i *)B,*C = (__m256i *)Out;

	karat_three_way_mult(C, A256, B256);
