...
int main(int argc, char* argv[]){
	...
	karat_mult3(resMul->i64, nA->i64,nB->i64);
	...
	printf("\nComparison with karat_mult3_AVX512 :\n-----------------------------\n");
	karat_mult3_AVX512(resMul->i64, nA->i64,nB->i64);
...
chrono:
	...
	else printf("gf2x vs karat_mult3: Victory !!!!!!!!!!!!!!!!!!!\n\n");
	counter=0;
	...
	if(counter) printf("%d errors !\nToo bad !!!!!!!!!!!!!!!!!!!\n\n",counter),counter=0;
	else printf("gf2x vs karat_mult3_AVX512: Victory !!!!!!!!!!!!!!!!!!!\n\n");
	counter=0;
	...
	printf("timer karat_mult3        : %llu\n",timer1/NSAMPLES);

	printf("timer karat_mult3_AVX512 : %llu\n",timer2/NSAMPLES);	
