...
#define SIZE_N (T_3W*9)

#define SIZE_N_64 ((T_3W*9)>>6)

#define TREC_3W (T_3W*3)
...
int karat_mult3_3(uint64_t * C, const uint64_t * A, const uint64_t * B);

int karat_mult3_3_AVX512(uint64_t * C, const uint64_t * A, const uint64_t * B);
