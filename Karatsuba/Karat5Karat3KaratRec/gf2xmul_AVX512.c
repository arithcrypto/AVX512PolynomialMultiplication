 ...
 * A(x) and B(x) are stored  in (5 x T_5W/512) 512-bit words
 * @param[out] C Pointer to the result
 * @param[in] A Pointer to the polynomial A(x)
 * @param[in] B Pointer to the polynomial B(x)
 */
inline static void karat_five_way_mult_m512i(__m512i *Out, const __m512i *A, const __m512i *B) {
	...
	karat_three_way_mult_512(D3, a3, b3);
	karat_three_way_mult_512(D4, a4, b4);

	karat_three_way_mult_512(D01, aa01, bb01);
	karat_three_way_mult_512(D02, aa02, bb02);
	karat_three_way_mult_512(D03, aa03, bb03);
	karat_three_way_mult_512(D04, aa04, bb04);
	
	karat_three_way_mult_512(D12, aa12, bb12);
	karat_three_way_mult_512(D13, aa13, bb13);
	karat_three_way_mult_512(D14, aa14, bb14);

	karat_three_way_mult_512(D23, aa23, bb23);
	karat_three_way_mult_512(D24, aa24, bb24);
	
	karat_three_way_mult_512(D34, aa34, bb34);
 ...
 * @param[in] B Pointer to the polynomial B(x)
 */
int karat_mult5_3_AVX512(uint64_t *Out, const uint64_t *A, const uint64_t *B) {
	__m512i *A512 = (__m512i *)A, *B512 = (__m512i *)B,*C = (__m512i *)Out;

	karat_five_way_mult_m512i(C, A512, B512);
