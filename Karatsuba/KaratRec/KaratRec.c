...
int main(int argc, char* argv[]){
	...
	printf("\nComparaison with karatRec :\n-----------------------------\n");
	karatRec(resMul->i64, nA->i64,nB->i64,t);
...
chrono:
	...
	else printf("gf2x vs karatRec: Victory !!!!!!!!!!!!!!!!!!!\n\n");
	counter=0;
	...
	for(int k=0; k<NSAMPLES;k++){
		...
		mini1 = (uint64_t)-1L, mini1 = (uint64_t)-1L;
	...
	printf("timing gf2x_mul        : %llu\n",timer/NSAMPLES);	
	
	printf("timing karatRec        : %llu\n",timer1/NSAMPLES);
...
*********************************************************/
	...
	printf("#Instructions gf2x_mul        : %llu\n",timer/NSAMPLES);	
	
	printf("#Instructions karatRec        : %llu\n",timer1/NSAMPLES);
