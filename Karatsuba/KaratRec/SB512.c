...
inline static void karat_mult_1_512(__m512i * C, const __m512i * A, const __m512i * B)
{
	...
	*/
	...
	R2_512=_mm512_clmulepi64_epi128(al,bh,0x10);
	R3_512=_mm512_clmulepi64_epi128(al,bh,0x11);
	...
	R2_512=_mm512_clmulepi64_epi128(ah,bl,0x10);
	R3_512=_mm512_clmulepi64_epi128(ah,bl,0x11);
	...
	cm ^= _mm512_permutex2var_epi64(l,mask,h);
	l = _mm512_permutexvar_epi64(perm_l, l );	
	h = _mm512_permutexvar_epi64(perm_h, h );
