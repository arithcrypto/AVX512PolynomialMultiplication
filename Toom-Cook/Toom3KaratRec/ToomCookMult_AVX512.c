...
#define T_TM3_3W_512 (T_3W / (8 * WORD))
...
/**
 * @brief Compute C(x) = A(x)*B(x) using Karatsuba multiplication
 *
...
void toom_3_mult_AVX512(__m512i * Out, const __m512i * A512, const __m512i * B512)
{
	...
	#if T_TM3_3W_512 == 16
	karat_mult_16_512( W1, W2, W3);
	#endif
	
	#if T_TM3_3W_512 == 32
	karat_mult_32_512( W1, W2, W3);
	#endif
	
	#if T_TM3_3W_512 == 64
	karat_mult_64_512( W1, W2, W3);
	#endif
	...
	#if T_TM3_3W_512 == 16
	//W3 = W3 * W2      ; W2 = W0 * W4
	karat_mult_16_512( tmp, W3, W2);
	for(int i=0;i<2*(T_TM3_3W_512);i++) W3[i] = tmp[i];
	karat_mult_16_512( W2, W0, W4);


	//W4 = U2 * V2      ; W0 = U0 * V0
	karat_mult_16_512( W4, U2, V2);
	karat_mult_16_512( W0, U0, V0);
	#endif
	
	#if T_TM3_3W_512 == 32
	//W3 = W3 * W2      ; W2 = W0 * W4
	karat_mult_32_512( tmp, W3, W2);
	for(int i=0;i<2*(T_TM3_3W_512);i++) W3[i] = tmp[i];
	karat_mult_32_512( W2, W0, W4);


	//W4 = U2 * V2      ; W0 = U0 * V0
	karat_mult_32_512( W4, U2, V2);
	karat_mult_32_512( W0, U0, V0);
	#endif
	
	#if T_TM3_3W_512 == 64
	//W3 = W3 * W2      ; W2 = W0 * W4
	karat_mult_64_512( tmp, W3, W2);
	for(int i=0;i<2*(T_TM3_3W_512);i++) W3[i] = tmp[i];
	karat_mult_64_512( W2, W0, W4);


	//W4 = U2 * V2      ; W0 = U0 * V0
	karat_mult_64_512( W4, U2, V2);
	karat_mult_64_512( W0, U0, V0);
	#endif
	...
	divByXplus1_512(W2,tmp,T_TM3_3W_256);
	...
	divByXplus1_512(W3,tmp,T_TM3_3W_256);
