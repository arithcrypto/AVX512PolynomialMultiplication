/*********************************************
	...
	Recursive Toom-Cook 3-way + Karatsuba 5-way Multiplication
	over GF_2[X]
...
int main(int argc, char* argv[]){
	...
	toom_3_mult(resMul->i256, nA->i256,nB->i256);
	...
	printf("\nComparison with toom_3_mult_AVX512 :\n-----------------------------\n");
	toom_3_mult_AVX512(resMul->i512, nA->i512,nB->i512);
...
chrono:
	...
	else printf("gf2x vs toom_3_mult: Victory !!!!!!!!!!!!!!!!!!!\n\n");
	counter=0;
	...
	if(counter) printf("%d errors !\nToo bad !!!!!!!!!!!!!!!!!!!\n\n",counter),counter=0;
	else printf("gf2x vs toom_3_mult_AVX512: Victory !!!!!!!!!!!!!!!!!!!\n\n");
	counter=0;
	...
	printf("timer toom_3_mult        : %llu\n",timer1/NSAMPLES);

	printf("timer toom_3_mult_AVX512 : %llu\n",timer2/NSAMPLES);	
