 ...
 * @param[in] B Pointer to the polynomial B(x)
 */
inline static void karat_three_way_mult_4096(__m256i *Out, const __m256i *A, const __m256i *B) {

#define T_3W 4096

#define T_3W_256 (T_3W>>8)
#define T2_3W_256 (2*T_3W_256)
#define TREC_3W_256 (3*T_3W_256)
...
inline static void karat_three_way_mult_8192(__m256i *Out, const __m256i *A, const __m256i *B) {
...
//
*************************************************************************************/
int karat_mult3(uint64_t *Out, const uint64_t *A, const uint64_t *B, int size) {
	__m256i *A256 = (__m256i *)A, *B256 = (__m256i *)B,*C = (__m256i *)Out;

	if (size == 4096)
		karat_three_way_mult_4096(C, A256, B256);
	else
		karat_three_way_mult_8192(C, A256, B256);
